...
TCL_EXTRA_CFLAGS='-pipe -fvisibility=hidden  -arch x86_64  '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Builds/deps/obj/tcl8.6.0 -ltcl8.6'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Builds/deps/obj/tcl8.6.0 -ltclstub8.6'
...
TCL_BUILD_STUB_LIB_PATH='/Builds/deps/obj/tcl8.6.0/libtclstub8.6.a'
